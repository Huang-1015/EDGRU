...
parser.add_argument("--model_names", default=['EDGRU'], type=list, help="model_name")
parser.add_argument("--pth_dirs", default=['NUDT-SIRST/EDGRU_best.pth.tar'], type=list, help="")
