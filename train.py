...
parser.add_argument("--model_names", default=['EDGRU'], type=list, help="model_name: EDGRU")
parser.add_argument("--dataset_names", default=['NUDT-SIRST'], type=list, help="dataset_name: 'NUAA-SIRST', 'NUDT-SIRST'")
...
parser.add_argument("--optimizer_settings", default={'lr': 3e-4}, type=dict, help="optimizer settings")
...
def train():
    ...
    if opt.optimizer_name == 'Adam':
        ...
        opt.scheduler_settings = {'epochs': 600, 'step': [250, 350, 450, 550], 'gamma': 0.5}
